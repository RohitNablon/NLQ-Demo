...
import metadata from '../extended_metadata.json'; // Importing local metadata
...
const AdminView = ({ onConnect, setShowPersonaSwitcher }) => {
    ...
    const currentItems = glossaryTerms.slice(indexOfFirstItem, indexOfLastItem);
    const totalPages = Math.ceil(glossaryTerms.length / itemsPerPage);
            ...
            case 2: // Analyze Data (Loader)
                return (
                    <div className="processing-step fade-in">
                        <LoaderScreen onComplete={handleProcessingComplete} duration={12000} />
                    </div>
                );
                        ...
                        <div className="schema-main-content">
                            <div className="step-header-actions">
                                ...
                                <div className="header-actions">
                                    <button className="btn btn-outline" onClick={() => setStep(1)}><ArrowRight size={16} style={{ transform: 'rotate(180deg)' }} /> Back</button>
                ...
                return (
                    <div className="glossary-step fade-in">
                        ...
                        <div className="step-header-actions">
                            ...
                            <div className="header-actions">
                                <button className="btn btn-outline" onClick={() => setStep(3)}><ArrowRight size={16} style={{ transform: 'rotate(180deg)' }} /> Back</button>
                        ...
                        <div className="glossary-table-wrapper">
                            <table className="kpi-table">
                                ...
                                <tbody className="glossary-table-body">
                                    {currentItems.map((term, index) => (
                                        <tr key={index} className="glossary-row fade-in-row" style={{ animationDelay: `${index * 0.05}s` }}>
                                            <td>
                                                <input
                                                    type="text"
                                                    value={term.term}
                                                    onChange={(e) => handleGlossaryChange(indexOfFirstItem + index, 'term', e.target.value)}
                                            ...
                                            <td>
                                                <input
                                                    type="text"
                                                    value={term.mapping}
                                                    onChange={(e) => handleGlossaryChange(indexOfFirstItem + index, 'mapping', e.target.value)}
                                                    className="glossary-input code-font"
                                                />
                                            </td>
                                            <td>
                                                <input
                                                    type="text"
                                                    value={term.definition || term.description}
                                                    onChange={(e) => handleGlossaryChange(indexOfFirstItem + index, 'definition', e.target.value)}
                                                    className="glossary-input"
                                                />
                                            </td>
                                            <td className="action-cell">
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        const newTerms = [...glossaryTerms];
                                                        newTerms.splice(indexOfFirstItem + index, 1);
                                                        setGlossaryTerms(newTerms);
                                                    }}
                                                >
                                                    <Trash2 size={16} />
                ...
                return (
                    <div className="ontology-step fade-in">
                        <div className="step-header-actions">
                            ...
                            <div className="header-actions">
                                <button className="btn btn-outline" onClick={() => setStep(4)}><ArrowRight size={16} style={{ transform: 'rotate(180deg)' }} /> Back</button>
                ...
                return (
                    <div className="ai-config-step fade-in">
                        <div className="step-header-actions">
                            ...
                            <div className="header-actions">
                                <button className="btn btn-outline" onClick={() => setStep(6)}><ArrowRight size={16} style={{ transform: 'rotate(180deg)' }} /> Back</button>
                ...
                return (
                    <div className="testing-step fade-in">
                        <div className="step-header-actions">
                            ...
                            <div className="header-actions">
                                <button className="btn btn-outline" onClick={() => setStep(7)}><ArrowRight size={16} style={{ transform: 'rotate(180deg)' }} /> Back</button>
                                <button className="btn btn-success" onClick={() => setStep(9)}>Submit for Onboard Review <CheckCircle size={16} /></button>
                            </div>
                        </div>
                    ...
                    <div className="completion-step fade-in">
                        <div className="completion-card">
                            ...
                            <p className="success-desc">
                                Your Agentic NLQ solution has been submitted for review. An Envoy product owner will reach out shortly for approval details to make your solution live.
                            </p>
                            <button className="btn btn-primary btn-lg" onClick={() => onConnect({ databaseType: selectedDb, connectionString: 'mock' })}>
                                Return to Workspace <ArrowRight size={20} />
                            </button>
                        </div>
                    </div>
                );
